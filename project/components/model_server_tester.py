...
#     context.data_path = f"store://datasets/gitops-project/train_test_set@{context.model_path.split('@')[1]}"
    context.data_path = f"store://datasets/gitops-project-new/train_test_set:{context.model_path.split(':')[2]}"
    # context.data_path = f"store://datasets/gitops-project-new/get-data_iris_dataset#0:latest"
